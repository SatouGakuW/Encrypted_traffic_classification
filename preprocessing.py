...
@click.command()
@click.option('-s', '--source', default='C:/Users/xdwww/Desktop/encrypted_traffic/Train',help='path to the directory containing raw pcap files', required=True)
@click.option('-t', '--target', default='processed_data',help='path to the directory for persisting preprocessed files', required=True)
